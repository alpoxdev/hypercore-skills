...
| 2 | Instructions Base | [`../README.md`](../README.md) | 로컬 안내 | 런타임 중립 core와 runtime profile을 분리하고, capability 중심으로 도구를 서술 | `README.md`, `capability-contract.md` |
| 3 | Runtime Profiles | [`../context-engineering/references/runtime-profiles.md`](../context-engineering/references/runtime-profiles.md) | 로컬 reference | 공통 규칙은 capability 중심, 런타임별 차이는 별도 profile에 둠 | 레이어와 용어 |
| 4 | Skill Authoring | [`../skill/SKILL_AUTHORING.md`](../skill/SKILL_AUTHORING.md) | 로컬 안내 | skill은 intent·scope·authority·tools·verification을 분리하고 안전 경계를 둠 | Skill 작성 패턴·검증 |
