...
이 문서는 **Claude Code CLI(`claude`)를 명시적으로 요청한 skill**의 실행 프로필이다. 일반 문서 작성이나 직접 로컬 편집의 기본 프로필이 아니다. 공통 계약은 [`../capability-contract.ko.md`](../capability-contract.ko.md)를 따른다.
